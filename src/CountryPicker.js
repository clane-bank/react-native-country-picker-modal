...
export default class CountryPicker extends Component {
  ...
  constructor(props) {
    super(props)
    console.log("Country Picker ---> "+JSON.stringify(props));
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        >
          <Fragment >
          <SafeAreaView forceInset={{ top: 'always' }} style={{backgroundColor:colors.blue}}/>
          <SafeAreaView forceInset={{ top: 'never' }} style={[styles.modalContainer, {backgroundColor: colors.white} ]}>
              <View style={{ backgroundColor: colors.blue, height: 50, flexDirection: 'row' }}>
                <TouchableOpacity style={{ justifyContent: 'flex-start', alignItems : 'flex-start',flex : 1 }} onPress={() => this.onClose()}>
